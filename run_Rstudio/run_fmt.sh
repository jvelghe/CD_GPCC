...
# Jane Velghe & Phil Richmond
# Oct. 4, 2022
# Rstudio launch for Verchere Lab FMT's project
...
Singularity_Image=/mnt/scratch/Precision/CD/rstudio-bioconductor-Release_3_15.simg

# Configure your data directory
Home_Dir=/mnt/scratch/Precision/CD/Verchere/fmt

# Configure your R Library Location
Lib_Dir=/mnt/scratch/Precision/CD/Vercere/fmt/R/x86_64-pc-linux-gnu-library/4.0/
#mkdir -p $Lib_Dir
...
###########################################################
cd /mnt/scratch/Precision/CD/Verchere/Rana
###########################################################
